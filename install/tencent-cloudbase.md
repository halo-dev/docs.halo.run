...
进入 [我的应用](https://console.cloud.tencent.com/tcb/apps/index) 页面，点击 `部署` 按钮，再点击 `确定` 按钮即可。

![tencent-cloudbase-9.png](/assets/tencent-cloudbase/tencent-cloudbase-9.png)
